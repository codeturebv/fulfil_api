...
module FulfilApi
  ...
  class CustomerShipment < Resource
    ...
    class << self
      ...
      #
      # @param id_or_ids [String, Integer, Array[String], Array[Integer]] The ID of the customer shipment to hold.
      ...
      #
      # @param id_or_ids [String, Integer, Array[String], Array[Integer]] The ID of the customer shipment to unhold.
